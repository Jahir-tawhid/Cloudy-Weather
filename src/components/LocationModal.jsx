...
const LocationModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-gray-950/60 z-50">
      <div className="h-[300px] p-5 rounded-2xl w-[400px] bg-gray-100 shadow-2xl">
        ...
        <div className="">
          <button
            ...
            className="text-lg w-full font-medium hover:scale-105 transition-all bg-red-500 px-5 cursor-pointer py-1 rounded-4xl text-gray-100"
          >
            Use My Locations
          </button>
        </div>
